...
if __name__ == '__main__':
    ...
    if not opts.text_display:
        ...
        display = graphics_grid_world_display.GraphicsGridWorldDisplay(mdp, opts.grid_size, opts.speed)
    try:
        display.start()
    ...
    if opts.agent == 'value':
        ...
        #env.get_possible_actions, opts.discount, opts.learning_rate, opts.epsilon
        #simulation_fn = lambda agent, state: simulation.GridWorldSimulation(agent,state,mdp)
