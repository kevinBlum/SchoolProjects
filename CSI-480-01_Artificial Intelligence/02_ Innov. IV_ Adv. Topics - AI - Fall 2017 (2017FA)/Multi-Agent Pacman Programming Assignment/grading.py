...
class Grades:
  ...
  def __init__(self, project_name, questions_and_maxes_list, edx_output=False, mute_output=False):
    """
...
""" % (prereq, q, q, prereq)
      ...
      if self.mute: util.mute_print()
      try:
        util.TimeoutFunction(getattr(grading_module, q),300)(self) # Call the question's function
        ...
        if self.mute: util.unmute_print()
